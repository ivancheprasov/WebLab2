                                        ...
                                        for (String xString : xArray) {
                                            ...
                                            if (!xString.equals("")) {
                                                ...
                                                if ((((x > 4) || (x < -4)) && !canvas) || (canvas && ((x > 10) || (x < -10)))){
                                                    ...
                                                    if((!xString.replace(",", ".").matches("^(4|-4|10|-10)(.0+)?$"))&&(x==4||x==-4||x==10||x==-10)) out.print("<li>" +
                                                            "Введено некорректное значение X" +
                                                            " или не входящее в допустимый диапозон. " +
                                                            "Введите значение от -4 до 4.</li>");
                                                }
                                ...
                                try {
                                    ...
                                    if (yArray.length == 1) {
                                        ...
                                        if ((((y > 3) || (y < -5)) && !canvas) || (canvas && ((y > 10) || (y < -10)))){
                                            ...
                                            if((!yArray[0].replace(",", ".").matches("^(3|-5|10|-10)(.0+)?$"))&&(y==3||y==-5||y==10||y==-10)) out.print("<li>" +
                                                    "Введено некорректное значение Y или не входящее в допустимый диапозон. " +
                                                    "Введите значение от -5 до 3.</li>");
                                        }
                                    } else {
                                ...
                                try {
                                    ...
                                    if (rArray.length == 1) {
                                        ...
                                        if (r < 1 || r > 5){
                                            ...
                                            if((!rArray[0].replace(",", ".").matches("^(1|5)(.0+)?$"))&&(r==1||r==5)) out.print("<li>" +
                                                    "Введено некорректное значение R или не входящее в допустимый диапозон. " +
                                                    "Введите значение от 1 до 5.</li>");
                                        }
                                    } else {
